...
// GetV1ToolsWithResponse provides a mock function with given fields: ctx, reqEditors
func (_m *MockClientWithResponsesInterface) GetV1ToolsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetV1ToolsResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetV1ToolsWithResponse")
	}

	var r0 *GetV1ToolsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...RequestEditorFn) (*GetV1ToolsResponse, error)); ok {
		return rf(ctx, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...RequestEditorFn) *GetV1ToolsResponse); ok {
		r0 = rf(ctx, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*GetV1ToolsResponse)
		}
	}
...
// GetWellKnownOauthProtectedResourceWithResponse provides a mock function with given fields: ctx, reqEditors
func (_m *MockClientWithResponsesInterface) GetWellKnownOauthProtectedResourceWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetWellKnownOauthProtectedResourceResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetWellKnownOauthProtectedResourceWithResponse")
	}

	var r0 *GetWellKnownOauthProtectedResourceResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...RequestEditorFn) (*GetWellKnownOauthProtectedResourceResponse, error)); ok {
		return rf(ctx, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...RequestEditorFn) *GetWellKnownOauthProtectedResourceResponse); ok {
		r0 = rf(ctx, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*GetWellKnownOauthProtectedResourceResponse)
		}
	}
