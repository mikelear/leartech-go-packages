...
// AdminDeleteTenantWithResponse provides a mock function with given fields: ctx, id, reqEditors
func (_m *MockClientWithResponsesInterface) AdminDeleteTenantWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*AdminDeleteTenantResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for AdminDeleteTenantWithResponse")
	}

	var r0 *AdminDeleteTenantResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ...RequestEditorFn) (*AdminDeleteTenantResponse, error)); ok {
		return rf(ctx, id, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, ...RequestEditorFn) *AdminDeleteTenantResponse); ok {
		r0 = rf(ctx, id, reqEditors...)
	} else {
		if ret.Get(0) != nil {
...
// AdminListAuditWithResponse provides a mock function with given fields: ctx, params, reqEditors
func (_m *MockClientWithResponsesInterface) AdminListAuditWithResponse(ctx context.Context, params *AdminListAuditParams, reqEditors ...RequestEditorFn) (*AdminListAuditResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for AdminListAuditWithResponse")
	}

	var r0 *AdminListAuditResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *AdminListAuditParams, ...RequestEditorFn) (*AdminListAuditResponse, error)); ok {
		return rf(ctx, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *AdminListAuditParams, ...RequestEditorFn) *AdminListAuditResponse); ok {
		r0 = rf(ctx, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*AdminListAuditResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *AdminListAuditParams, ...RequestEditorFn) error); ok {
