...
// Example provides a mock function with given fields: ctx, reqEditors
func (_m *MockClientInterface) Example(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
